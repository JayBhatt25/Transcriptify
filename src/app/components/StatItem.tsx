...
function StatItem({iconName, statNumber}:Readonly<{
  ...
  return (
    <div className="w-[354.67px] h-[140px] rounded-2xl border  p-4 gap-4 flex flex-col bg-[#FFFFFF]">
        ...
        <div className="heading-number-container w-[322.67px] h-[52px] gap-2 flex flex-col">
            ...
            <span className="font-Inter font-normal text-sm text-[#475367]">{iconName}</span>
        </div>
    </div>
  )
}
